...
private:
    friend void* operator new(size_t t) _THROW_BAD_ALLOC;
    friend void operator delete(void* p) _NOEXCEPT;
    ...
    std::vector<BlockAllocationRecord> mAllocationRecords[ALLOC_TABLE_HASH_SIZE];
};
